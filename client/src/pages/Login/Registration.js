...
import './Login.css'
import * as regisActions from "../../redux/actions/RegisActions"
...
class Registration extends Component {
    ...
    handleSignInRegister = async (e, v) => {
        console.log(v)
        this.props.dispatch(regisActions.registration({v, history: this.props.history}))
    }
            ...
            <div className="container-fluid loginPage d-flex">
                <div className={"m-auto registration "}>
                    ...
                    <div className={"firstInputs mt-2"}>
                        <AvForm className={"mx-auto"} onValidSubmit={this.handleSignInRegister}>
                            <div className={"form-group"}>
                                <Label for="fname" className="ml-0">To`liq ism sharif</Label>
                                <AvField type="text" name="fullName" className="form-control login-input"
                                         placeholder="Aliyev Vali" style={this.state.styles} id="fname" required/>
